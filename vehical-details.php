...
<div class="form-group">
    ...
    <div class="invalid-feedback">To Date must be greater than or equal to From Date.</div>
</div>
...
<script>
    ...
    function validateDateRange() {
        ...
        if (toDate < fromDate) {
            document.getElementById("toDate").setCustomValidity("To Date must be greater than or equal to From Date.");
        } else {
            document.getElementById("toDate").setCustomValidity("");
        }
    }

    // Attach event listener to the "change" event of both date inputs
